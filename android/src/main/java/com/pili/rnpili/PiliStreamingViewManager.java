...
//                    .setEncodingOrientation(StreamingProfile.ENCODING_ORIENTATION.PORT)
            ...
            //setting.setCameraPreviewSize(w,h)
...
//        int encodingSize = profile.getInt("encodingSize");
        ReadableMap videoSize = profile.getMap("videoSize");
        int videoHeight = videoSize.getInt("height");
        int videoWidth = videoSize.getInt("width");
...
//        mProfile.setEncodingSizeLevel(encodingSize);
        mProfile.setPreferredVideoEncodingSize(videoWidth,videoHeight);
...
//    }
    ...
    private void stopStreaming() {
        ...
        context.getCurrentActivity().getWindow().clearFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
    }
